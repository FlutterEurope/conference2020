...
Future<List<QrCameraDescription>> availableCameras() async {
  try {
    final List<dynamic> cameras =
        await _channel.invokeMethod('availableCameras');
    return cameras.map((dynamic camera) {
      return new QrCameraDescription(
        name: camera['name'],
...
class QrCameraDescription {
  ...
  QrCameraDescription({this.name, this.lensDirection});

  @override
  bool operator ==(Object o) {
    return o is QrCameraDescription &&
        o.name == name &&
