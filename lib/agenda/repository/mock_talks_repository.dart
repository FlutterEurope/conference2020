...
final _talks = <Talk>[
  ...
  Talk('2', _titles[2], [_authors[3]], DateTime(2020, 1, 23, 10, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('3', _titles[3], [_authors[4]], DateTime(2020, 1, 23, 10, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('4', _titles[4], [_authors[5]], DateTime(2020, 1, 23, 11, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('5', _titles[5], [_authors[6]], DateTime(2020, 1, 23, 11, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('6', _titles[6], [_authors[7]], DateTime(2020, 1, 23, 12, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('7', _titles[7], [_authors[8]], DateTime(2020, 1, 23, 12, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('8', _titles[8], [_authors[9]], DateTime(2020, 1, 23, 13, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('9', _titles[9], [_authors[10]], DateTime(2020, 1, 23, 13, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('10', _titles[10], [_authors[11]], DateTime(2020, 1, 23, 15, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('11', _titles[11], [_authors[12]], DateTime(2020, 1, 23, 15, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('12', _titles[12], [_authors[13]], DateTime(2020, 1, 23, 16, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('13', _titles[13], [_authors[14]], DateTime(2020, 1, 23, 16, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('15', _titles[15], [_authors[16]], DateTime(2020, 1, 23, 17, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('16', _titles[16], [_authors[17]], DateTime(2020, 1, 23, 17, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  //Day2
  Talk('17', _titles[17], [_authors[18]], DateTime(2020, 1, 24, 9, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('19', _titles[19], [_authors[23]], DateTime(2020, 1, 24, 10, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('20', _titles[20], [_authors[24]], DateTime(2020, 1, 24, 10, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('21', _titles[21], [_authors[25]], DateTime(2020, 1, 24, 11, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('22', _titles[22], [_authors[26]], DateTime(2020, 1, 24, 11, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('23', _titles[23], [_authors[27]], DateTime(2020, 1, 24, 12, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('24', _titles[24], [_authors[28]], DateTime(2020, 1, 24, 12, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('25', _titles[25], [_authors[29]], DateTime(2020, 1, 24, 15, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('26', _titles[26], [_authors[29]], DateTime(2020, 1, 24, 15, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('27', _titles[27], [_authors[4]], DateTime(2020, 1, 24, 16, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
  Talk('28', _titles[28], [_authors[0]], DateTime(2020, 1, 24, 16, 0),
      DateTime(2020, 1, 23, 9, 45), _rB),
  Talk('29', _titles[29], [_authors[1]], DateTime(2020, 1, 24, 17, 0),
      DateTime(2020, 1, 23, 9, 45), _rA),
];
